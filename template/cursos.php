            ...
            <ul class="nav nav-pills category-isotope center-nav">
               ...
               <li class="nav-item">
                  <a class="nav-link" href="#" data-toggle="tab" data-filter=".info">Informática</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="#" data-toggle="tab" data-filter=".port">Português</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="#" data-toggle="tab" data-filter=".mat">Matemática</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" href="#" data-toggle="tab" data-filter=".rob">Robótica</a>
               </li>
               <li class="nav-item">
